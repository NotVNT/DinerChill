    ...
    const checkPaymentStatus = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_BASE_URL}/payment/info/${orderCode}${queryParams}`
        );
    ...
    if (isCancelled) {
      return (
        <div className="payment-cancelled">
          ...
          <p>
            Đặt bàn của bạn đã được hủy. Bạn có thể quay lại danh sách nhà hàng
            để đặt lại.
          </p>
          ...
          {isPaid ? (
            <>
              ...
              <div className="payment-details">
                ...
                <p>
                  <strong>Mô tả:</strong>{" "}
                  {paymentStatus.transactions?.[0]?.description ||
                    `Thanh toán ${paymentStatus.orderCode}`}
                </p>
                <p>
                  <strong>Số tiền:</strong>{" "}
                  {paymentStatus.amount?.toLocaleString()}đ
                </p>
                <p>
            ...
            <>
              ...
              <div className="payment-details">
                ...
                <p>
                  <strong>Trạng thái:</strong> {paymentStatus.status}
                </p>
              </div>
            </>
          )}
