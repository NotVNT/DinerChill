...
const TaskPricingPage = () => {
          ...
          <div className="card shadow-sm">
            <div className="row p-4">
              <div className="col-12 mb-2 text-center">
                ...
                <p>
                    DinerChill cung cấp các gói dịch vụ linh hoạt, được thiết kế để đáp ứng đa dạng nhu cầu kinh doanh của các nhà hàng. Khám phá các gói dưới đây để tìm lựa chọn phù hợp với bạn!
                </p>
            </div>
                ...
                <div className="card h-100">
                  <div className="card-body d-flex flex-column justify-content-between">
                      ...
                      <h4 className="fs-4">Gói bắt đầu</h4>
                            <p>
                                Thêm kênh bán hàng thông qua khai thác cộng đồng thực khách trên DinerChill, khai thác nền tảng chuyên về dịch vụ đặt chỗ trước khi đến để Nhà hàng có thêm khách.
                            </p>
                        </div>
                    <div className="fw-medium fs-5">
                            Miễn phí/Mỗi tháng<br />
                      <button className="btn btn-dark mt-2 px-4" onClick={() => window.open('https://forms.gle/X1FWGJpgYdTGT9cf7', '_blank', 'noopener noreferrer')}>
                        Đăng ký
                      </button>
                        </div>
                    </div>
                ...
                <div className="card h-100">
                  <div className="card-body d-flex flex-column justify-content-between">
                      ...
                      <h4 className="fs-4">Gói cơ bản</h4>
                            <p>
                                Không chỉ giúp bạn có thêm khách hàng, bạn có thể tự mình tối ưu sản phẩm, dịch vụ, tối ưu điều hành nhà hàng của bạn dễ hơn. Phần mềm giúp bạn quản lý hiệu quả kinh doanh.
                            </p>
                        </div>
                    <div className="fw-medium fs-5">
                            Từ 299K/Mỗi tháng<br />
                      <button className="btn btn-dark mt-2 px-4" onClick={() => window.open('https://forms.gle/X1FWGJpgYdTGT9cf7', '_blank', 'noopener noreferrer')}>
                        Đăng ký
                      </button>
                        </div>
                ...
                <div className="card h-100">
                  <div className="card-body d-flex flex-column justify-content-between">
                      ...
                      <h4 className="fs-4">Gói cốt lõi</h4>
                            <p>
                                Một giải pháp gần như hoàn chỉnh nhất để bạn xây dựng nhà hàng của mình kinh doanh không chỉ đông khách hơn mà còn hoạt động hiệu quả, hiệu suất, ổn định.
                            </p>
                        </div>
                    <div className="fw-medium fs-5">
                            Từ 999K/Mỗi tháng<br />
                      <button className="btn btn-dark mt-2 px-4" onClick={() => window.open('https://forms.gle/X1FWGJpgYdTGT9cf7', '_blank', 'noopener noreferrer')}>
                        Đăng ký
                      </button>
                        </div>
              ...
              <div className="col-12 mt-4">
                <h3 className="fs-4 fw-bold">2. Bảng chi tiết các tác vụ theo gói dịch vụ DinerChill.</h3>
                ...
                <div className="table-responsive">
                  <table className="table table-bordered table-striped align-middle scp-service-table">
                        <thead>
                      <tr>
                        <th style={{ width: '40%' }} className="fs-4 fw-medium" scope="col">Tác vụ</th>
                        <th style={{ width: '20%' }} className="fs-4 text-center fw-medium" scope="col">Gói bắt đầu</th>
                        <th style={{ width: '20%' }} className="fs-4 text-center fw-medium" scope="col">Gói cơ bản</th>
                        <th style={{ width: '20%' }} className="fs-4 text-center fw-medium" scope="col">Gói cốt lõi</th>
                            </tr>
                        </thead>
                        <tbody>
                      <tr>
  ...
  <tr>
    ...
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">Không giới hạn, tới 20 Mức đích</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td className="text-center">Mô tả chứ (text) + Ảnh (nâng cấp dần)</td>
    <td className="text-center">Mô tả chứ (text) & Ảnh + Video (nâng cấp dần)</td>
  </tr>
  <tr>
    <td>Giới thiệu</td>
    <td className="text-center"></td>
  ...
  <tr>
    ...
    <td className="text-center">Mô tả</td>
    <td className="text-center">Mô tả & Thêm ảnh + video (nâng cấp dần)</td>
  </tr>
  <tr>
    <td>Tổng số chỗ</td>
    <td className="text-center"></td>
  ...
  <tr>
    ...
    <td className="text-center">Từ 5-7 từ khóa<br/>(Có lựa chọn Gian hàng đặt từ khóa)</td>
    <td className="text-center">Từ 7-10 từ khóa<br/>(Có lựa chọn Gian hàng đặt từ khóa)</td>
  </tr>
  <tr>
    <td>Gắn địa danh</td>
    <td className="text-center">✔</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">Được gắn nhãn truyền thông</td>
  </tr>
   <tr>
    <td>BST Gian hàng - Mức dịch đi ăn</td>
    <td className="text-center">Tối đa 4 BST</td>
    <td className="text-center">Tối đa 7 BST</td>
    <td className="text-center">1. Không giới hạn BST<br/>2. Ưu tiên Top10/BST<br/>3. Được gắn nhãn truyền thông</td>
  </tr>
   <tr>
    <td>BST Gian hàng Ưu đãi hấp dẫn</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">Nếu đủ điều kiện + Ưu tiên top10 + Được gắn nhãn truyền thông</td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">Top10 trong 7 ngày. Đổi lùi dần về sau.</td>
  </tr>
  <tr>
    <td>Thứ tự KP top địa điểm - Về Món ăn đặc sắc/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">Top10 trong 7 ngày. Đổi lùi dần về sau.</td>
  </tr>
  <tr>
    <td>KP Top địa điểm - Về Loại hình ẩm thực Quốc gia/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
  <tr>
    <td>Thứ tự KP top địa điểm - Về Loại hình ẩm thực Quốc gia/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
  <tr>
    <td>KP Top địa điểm - Về Mức dịch đi ăn của thực khách/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
  <tr>
    <td>Thứ tự KP top địa điểm - Về Mức dịch đi ăn của thực khách/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>KP Top địa điểm - Về các địa điểm ăn uống có phong cách hay gì đó đặc sắc/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>Thứ tự KP top địa điểm - Về các địa điểm ăn uống có phong cách hay gì đó đặc sắc/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>KP Top địa điểm - Có mặt trong các địa danh nổi tiếng/Khu vực</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>Thứ tự KP top địa điểm - Có mặt trong các địa danh nổi tiếng/Khu vực</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>KP Top địa điểm - Có mặt trong danh sách các nhà hàng dịch vụ ăn uống/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
    <tr>
    <td>Thứ tự KP top địa điểm - Có mặt trong danh sách các nhà hàng dịch vụ ăn uống/Khu vực</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>KP Top địa điểm - Nhóm nhà hàng theo thời điểm đi ăn</td>
    <td className="text-center"></td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
   <tr>
    <td>Thứ tự KP top địa điểm - Nhóm nhà hàng theo thời điểm đi ăn</td>
    <td className="text-center"></td>
    <td className="text-center">✔</td>
    <td className="text-center">✔</td>
  </tr>
  <tr>
    ...
    <td className="text-center"></td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">1. Có mặt<br/>2. Vị trí do Dinner Chill sắp xếp</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td>Trang chủ 7: Nhà hàng xuất hiện nhiều lượt xem tuần</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">1. Có mặt<br/>2. Vị trí do Dinner Chill sắp xếp</td>
  </tr>
   ...
   <tr>
    <td>Trang chủ 9: Bạn muốn tìm nhà hàng theo dịp đặc biệt</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">Nếu đủ điều kiện</td>
    <td className="text-center">1. Có mặt<br/>2. Vị trí do Dinner Chill sắp xếp</td>
  </tr>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="subscriptionModalLabel">Đăng ký gói dịch vụ</h5>
