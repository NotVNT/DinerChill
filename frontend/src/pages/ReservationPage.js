...
function ReservationPage() {
  ...
  const handleDepositConfirm = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        try {
          ...
          if (paymentResponse.data && paymentResponse.data.checkoutUrl) {
            ...
            setSuccessMessage(
              `Đặt bàn thành công với mã ${reservationId}! Vui lòng thử lại thanh toán.`
            );
          }
        } catch (paymentError) {
          console.error("Payment error:", paymentError);
          setSuccessMessage(
            `Đặt bàn thành công với mã ${reservationId}! Thanh toán không thành công, vui lòng thử lại sau.`
          );
        }
      } else {
      ...
      setError(
        err.message || "Có lỗi xảy ra khi đặt bàn. Vui lòng thử lại sau."
      );
            ...
            <div className="deposit-content">
              <div className="deposit-amount-box">
                ...
                <div className="deposit-amount-text">
                  ...
                  <p className="deposit-amount-value">
              ...
              <div className="deposit-info">
                <p>
                  Bạn sẽ được chuyển đến trang thanh toán để hoàn tất đặt cọc.
                </p>
              </div>
            </div>
