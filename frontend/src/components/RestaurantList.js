...
function RestaurantList() {
  ...
  useEffect(() => {
    ...
    if (filter === 'reputable') {
      ...
      filtered = filtered.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)); // Mới nhất: sắp xếp theo ngày tạo
    }
  ...
  const categories = [
    'all', 'Nhà hàng', 'Lẩu', 'Buffet', 'Hải sản', 'Lẩu & Nướng', 'Quán Nhậu', 
    'Món chay', 'Đặt tiệc', 'Hàn Quốc', 'Nhật Bản', 'Món Âu', 'Món Việt', 
    'Món Thái', 'Món Trung', 'Món Hoa', 'Tiệc cưới',
  ];
