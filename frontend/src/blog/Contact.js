...
const Contact = () => {
  return (
    <div style={{ maxWidth: 800, margin: '32px auto', background: '#fff', fontFamily: 'Segoe UI, Arial, Helvetica, sans-serif', fontSize: 15, color: '#222', padding: 32, borderRadius: 16, boxShadow: '0 4px 24px #e0e0e0', border: '1px solid #f3f3f3' }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, marginBottom: 8, color: '#d81f26' }}>
        Liên hệ đầu tư & hợp tác với Dinner Chill
      </h1>
      <h2 style={{ fontSize: 16, fontWeight: 600, margin: 0, marginBottom: 18, color: '#222' }}>
      ...
      <div style={{ marginBottom: 18, color: 'Chúng tôi luôn trân trọng mọi đề xuất hợp tác và đầu tư từ cá nhân, tổ chức có thiện chí và quan tâm đến lĩnh vực đặt chỗ trực tuyến, nhà hàng, khách sạn, du lịch.#444' }}>
        ...
        <ol style={{ marginTop: 10, marginBottom: 10, paddingLeft: 22 }}>
      ...
      <div style={{ marginBottom: 0, color: '#888', fontSize: 14 }}>
